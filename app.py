...
def init_db():
    with app.app_context():
        ...
        borrow_record1 = BorrowRecord(user_id=1, book_id=1, borrow_date=date(2025, 1, 4), return_date=None)
        borrow_record2 = BorrowRecord(user_id=2, book_id=2, borrow_date=date(2025, 1, 4), return_date=None)
        borrow_record3 = BorrowRecord(user_id=3, book_id=3, borrow_date=date(2025, 1, 4), return_date=None)
